...
const CardMakanan = ({ products, isFiltered }) => {
    ...
    //fungsi jika ada jenis dan tipe
    ...
    //fungsi menambahkan menu sesuai dengan jenis dan tipe yang dipilih jika ada
    ...
    const displayProducts = isFiltered ? products : makananCount;
